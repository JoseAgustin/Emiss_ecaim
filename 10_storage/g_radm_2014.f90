...
tiempo: do it=iit,eit
		...
		if(ikk.eq.1) then
         write(current_date(12:13),'(I2.2)')it
          ...
          do i=1, nx
            do j=1, ny
              do l=1,zlev
                 ea(i,j,l,1)=eft(i,j,ikk,it+1,l)*SUPF1
              end do
            end do
          end do
          else
          do i=1, nx
            do j=1, ny
              do l=1,zlev
                ea(i,j,l,1)=(eft(i,j,ikk,it+1,l)+eft(i,j,imt,it+1,l))*SUPF1
              end do
            end do
          end do
          end if
      ...
      if(ikk.ne.jcn)then
        do i=1, nx
          do j=1, ny
            do l=1,zlev
              ea(i,j,l,1)=eft(i,j,ikk,it+1,l)*SUPF1 !entre 9x9 km
            end do
          end do
        end do
        else
        do i=1, nx
          do j=1, ny
            do l=1,zlev
              ea(i,j,l,1)=(eft(i,j,ikk,it+1,l)+eft(i,j,icn,it+1,l))*SUPF1
            end do
          end do
        end do
        end if
